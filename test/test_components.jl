@testset "Components" begin
    ...
    let f(; name="John", surname="Doe") = htm"<div class=name><h1>$surname,</h1> <h2>$name</h2></div>"
        @test htm"<div class=person><f /></div>" == JSX.Node(:div, [:class => "person"], [JSX.Node(:component, [], [f()])])
        @test htm"<div class=person><f name=Sarah /></div>" == JSX.Node(:div, [:class => "person"], [JSX.Node(:component, [], [f(name="Sarah")])])
        @test htm"<div class=person><f surname=Silva /></div>" == JSX.Node(:div, [:class => "person"], [JSX.Node(:component, [], [f(surname="Silva")])])
        @test htm"<div class=person><f name=João surname=Silva /></div>" == JSX.Node(:div, [:class => "person"], [JSX.Node(:component, [], [f(name="João", surname="Silva")])])
        @test htm"<div class=person><f name=João surname=Silva/></div>" == JSX.Node(:div, [:class => "person"], [JSX.Node(:component, [], [f(name="João", surname="Silva")])])
        @test htm"<div class=person><f surname=Silva name=João /></div>" == JSX.Node(:div, [:class => "person"], [JSX.Node(:component, [], [f(name="João", surname="Silva")])])
    end
end