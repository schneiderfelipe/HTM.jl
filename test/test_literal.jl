@testset "Literals" begin
    ...
    @test htm"<hr/>" == JSX.Node(:hr, [], [])
    @test htm"<meta charset=\"UTF-8\" />" == JSX.Node(:meta, [:charset => "UTF-8"], [])
    ...
    @test htm"<a href=\"kitty.jpg\">A kitty!</a>" == JSX.Node(:a, [:href => "kitty.jpg"], [JSX.Node(:text, [], ["A kitty!"])])
